...
public class IIOPK implements MouseListener
{
...
class ImagePanel extends JPanel {
    ...
    //It's a method in JPanel that I've overwritten to paint the background and foreground images
     ...
     public void drawStrings(Graphics g)
     {
        ...
        g.drawString("Distance: " + IIOPK.distance,30,500);
        g.setFont(new Font("Arial",Font.BOLD,20));
        if (IIOPK.distance > IIOPK.maxDistance)
            g.drawString("Best: " + IIOPK.distance,650,500);
        else
            g.drawString("Best: " + IIOPK.maxDistance,650,500);
        if(IIOPK.paused)
        {
